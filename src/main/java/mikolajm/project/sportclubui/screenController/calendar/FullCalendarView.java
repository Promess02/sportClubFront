...
public class FullCalendarView {
    ...
    public void populateCalendar(YearMonth yearMonth) {
        ...
        for (AnchorPaneNode ap : allCalendarDays) {
            ...
            Map<LocalDate, Calendar> mapOfCalendar = calendarList.stream()
                    .collect(Collectors.toMap(Calendar::getDate, calendar -> calendar));
            Text txt = new Text(String.valueOf(calendarDate.getDayOfMonth()));
//            LocalDate localDate = LocalDate.of(yearMonth.getYear(),yearMonth.getMonthValue(),calendarDate.getDayOfMonth());
